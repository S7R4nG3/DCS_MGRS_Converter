...
class CoordConvert:
    def __init__(self, input_format, input_data):
        ...
        if input_format.lower() == 'mgrs':
            ...
            dms_string = "N {:.0f} {:.0f} {:.4f},".format(lat['d'],lat['m'],lat['s']) + 'E ' if lon['d'] > 0 else 'W ' + '{:.0f} {:.0f} {:.4f}'.format(abs(lon['d']),lon['m'],lon['s'])
            print('MGRS to Decimal: {:.4f} {:.4f}'.format(latd,lond))
        ...
        if input_format.lower() == 'dd':
            ...
            dms_string = 'N {:.0f} {:.0f} {:.4f}, E 0{:.0f} {:.0f} {:.4f}'.format(lat['d'],lat['m'],lat['s'],lon['d'],lon['m'],lon['s'])
